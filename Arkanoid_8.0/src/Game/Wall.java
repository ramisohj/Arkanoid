...
public class Wall {
    ...
    public void fillBockList(){
        ArrayList<Block> l1 = fillRow(5, 200, 100, 200, 20, Color.BLUE);
        ArrayList<Block> l2 = fillRow(5, 100, 130, 200, 20, Color.BLUE);
        ArrayList<Block> l3 = fillRow(5, 200, 160, 200, 20, Color.BLUE);
        ArrayList<Block> l4 = fillRow(5, 100, 190, 200, 20, Color.BLUE);
        ArrayList<Block> l5 = fillRow(5, 200, 220, 200, 20, Color.BLUE);
        ArrayList<Block> l6 = fillRow(5, 100, 250, 200, 20, Color.BLUE);
        ArrayList<Block> l7 = fillRow(5, 200, 280, 200, 20, Color.BLUE);
        ArrayList<Block> l8 = fillRow(5, 100, 310, 200, 20, Color.BLUE);
